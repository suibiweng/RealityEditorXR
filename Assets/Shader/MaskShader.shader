	...
	LOD 0
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float2 texCoord4 = IN.ase_texcoord9.xy * float2( 0.33,1 ) + float2( 0,0 );
				float2 texCoord7 = IN.ase_texcoord9.xy * float2( 0.34,1 ) + float2( 0.66,0 );
				
				o.Albedo = ( tex2D( _Main, texCoord4 ) * tex2D( _Main, texCoord7 ) ).rgb;
		...
		Pass
		{
			...
			)
			{
				...
				float2 texCoord4 = IN.ase_texcoord8.xy * float2( 0.33,1 ) + float2( 0,0 );
				float2 texCoord7 = IN.ase_texcoord8.xy * float2( 0.34,1 ) + float2( 0.66,0 );
		...
		Pass
		{
				...
				) : SV_Target
			{
				...
				float2 texCoord4 = IN.ase_texcoord3.xy * float2( 0.33,1 ) + float2( 0,0 );
				float2 texCoord7 = IN.ase_texcoord3.xy * float2( 0.34,1 ) + float2( 0.66,0 );
...
ASEEND*/
//CHKSM=1E48EDDAAA57C5B007E32AEEC48C89D75CA91E09